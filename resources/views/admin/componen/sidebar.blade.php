<aside>
<class="sid ebar navbar navbar-expand-1g bg-dark d-flex flex-column gap-4 align-content-lg-center mx-2 my-2">
...
<li class="navbar-item">
<a href="{{ route('page.produtcs.index') }}" class="">
<div class="d-flex gap-3">
...
<li class="navbar-item">
<a href="{{ route('page.users.index') }}" class="">
<div class="d-flex gap-3">
